...
Bonuses use sign-aware multiplier. Under target: `Total = Blended × (1 + Geo + Rep Pres.)`. Over target: `Total = Blended × (1 - Geo - Rep Pres.)`. Bonuses make reps more competitive without overriding balance logic.
